...
namespace ORB_SLAM2 {
    ...
    void DataDriver::updateKeyFramePosesToServer( std::set<LightKeyFrame> tUpdateKFs ) {
        ...
        ros::NodeHandle n;
        ros::ServiceClient client = n.serviceClient<corbslam_msgs::corbslam_update>("updateKeyFrameToMap");
        corbslam_msgs::corbslam_update srv;
    ...
    void DataDriver::updateMapPointPosesToServer(  std::set<LightMapPoint> tUpdateMPs ) {
        ...
        ros::NodeHandle n;
        ros::ServiceClient client = n.serviceClient<corbslam_msgs::corbslam_update>("updateMapPointToMap");
        corbslam_msgs::corbslam_update srv;
    ...
    void DataDriver::insertNewKeyFramesToServer( std::set<LightKeyFrame> newInsertedKFs ) {
        ...
        ros::NodeHandle n;
        ros::ServiceClient client = n.serviceClient<corbslam_msgs::corbslam_insert>("insertKeyFrameToMap");
        corbslam_msgs::corbslam_insert srv;
    ...
    void DataDriver::insertNewMapPointsToServer( std::set<LightMapPoint> newInsertedMPs ) {
        ...
        ros::NodeHandle n;
        ros::ServiceClient client = n.serviceClient<corbslam_msgs::corbslam_insert>("insertMapPointToMap");
        corbslam_msgs::corbslam_insert srv;
