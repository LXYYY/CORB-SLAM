...
namespace ORB_SLAM2 {
    ...
    private:
        ...
        void subNewInsertKeyFramesFromServer(  const corbslam_msgs::corbslam_message::ConstPtr& msg  );
        void subNewInsertMapPointFromServer(  const corbslam_msgs::corbslam_message::ConstPtr& msg  );

        void subUpdatedKeyFramesPose(  const corbslam_msgs::corbslam_message::ConstPtr& msg  );
        void subUpdatedMapPointsPose(  const corbslam_msgs::corbslam_message::ConstPtr& msg  );
